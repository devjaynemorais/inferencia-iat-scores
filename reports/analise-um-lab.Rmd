...
### Conclusão
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) com a matemárica **negativa** e **forte** (média 0.5703113, desv. padrão 0.4229594, N = 65). Homens tiveram uma associação **negativa** com a matemática, portanto **menor** que a das mulheres (média = 0.3997566, desv. padrão = 0.5162869, N = 48). Houve portanto uma **pequena** diferença entre homens e mulheres (diferença das médias -0.1705546, 95% CI [-0.342834, 0.01478192]). A partir desta amostra, estimamos que...

* mulheres têm uma associação negativa consideravelmente mais forte, com uma diferença que provavelmente está entre -0.342834, 0.01478192 ponto na escala IAT, HÁ UMA DIFERENÇA PEQUENA.


#### Um exemplo 
#### Dataset antigo
Se a diferença entre homens e mulheres fosse (diferença das médias -0.2430539, 95% CI [-0.4315714, -0.07379393]). A partir desta amostra, estimamos que...
* mulheres têm uma associação negativa consideravelmente mais forte, com uma diferença que provavelmente está entre -0.4315714, -0.07379393 ponto na escala IAT, o que não podemos concluir se é uma diferença grande ou pequena, pois 
o valor que está dentro desse intervalo, pode tanto ser muito próximo a zero, tanto distante de zero no outro ponto.
--- 
